...
resource "aws_lambda_permission" "allow_cognito" {
  ...
  function_name = aws_lambda_function.cruddur_post_confirmation2.function_name
...
output "lambda_function_arn" {
  ...
  value       = aws_lambda_function.cruddur_post_confirmation2.arn
}

output "lambda_function_name" {
  description = "Name of the Lambda function"
  value       = aws_lambda_function.cruddur_post_confirmation2.function_name
}
...
data "archive_file" "lambda_zip" {
  type        = "zip"
  source_file = local_file.lambda_source.filename
  output_path = "${path.module}/${var.function_name_cruddur_messaging_stream}.zip"
  depends_on  = [local_file.lambda_source]
}
